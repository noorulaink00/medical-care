          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between ">
            ...
            <div className="">
              <div className="lg:w-[570px]">
                <h1
                  className="text-[36px] md:text-[60px] leading-[46px] text-headingColor font-[800]
            md:leading-[70px]"
                >
                ...
                <p className="text__para">
                  ...
                  ipsam esse odit aliquid aperiam nobis, aliquam, nemo corrupti,
                  perspiciatis dolorum cumque. Quam deleniti voluptate libero
                  sed quidem nulla, totam assumenda!
                </p>
        ...
        <div className="container">
          <div className="mx-auto lg:w-[470px]">
            ...
            <p className="text__para text-center">
              World-class care for everyone. Our health care offers unmateched
              care for you.
            </p>
          </div>
